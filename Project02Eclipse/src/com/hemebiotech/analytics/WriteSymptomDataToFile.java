...
public class WriteSymptomDataToFile implements ISymptomWriter {
	...
	public Map<String, Integer> countAndSort(List<String> symptomList) {
		...
		// We check if the symptom exists in the file and we count its number of occurrences
		...
		System.out.println("We have " + symptomOccurence.size() + " distinct(s) symptoms listed: ");
		System.out.println("--------------------------------------- ");
